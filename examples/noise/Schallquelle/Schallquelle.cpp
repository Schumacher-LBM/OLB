...
Bei dem ausführen des Programms mus mit --iTmax XXX eine Zahl angegeben werden, wieviele Iterationsdurchläufe das Programm durchläuft*/
  ...
  std::size_t iT, SuperGeometry<T,ndim>& superGeometry)
{
  ...
  AnalyticalConst3D<T,T> rhoF(1.+0.1*std::sin(iT*0.025*std::numbers::pi_v<T>/40.));       // assuming T=40 iterations
